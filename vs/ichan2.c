...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
...
#endif
  hoc_register_prop_size(_mechtype, 37, 9);
  ...
  hoc_register_dparam_semantics(_mechtype, 8, "ks_ion");
 	...
 	ivoc_help("help ?1 ichan2 C:/Users/tlu/Documents/GitHub/rise-group-a-2020/vs/ichan2.mod\n");
...
static int  rates (  double _lv ) {
 ...
 _zq10 = pow( 3.0 , ( ( celsius - 6.3 ) / 10.0 ) ) ;
   _lalpha = - 0.3 * vtrap ( _threadargscomma_ ( _lv - vshift + 60.0 - 17.0 ) , - 5.0 ) ;
   _lbeta = 0.3 * vtrap ( _threadargscomma_ ( _lv - vshift + 60.0 - 45.0 ) , 5.0 ) ;
 ...
 v=_v;
{
  ...
  eks = _ion_eks;
 { error =  states();
 if(error){fprintf(stderr,"at line 74 in file ichan2.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 }   }}
...
static const char* nmodl_file_text = 
  ...
  "	alpha = -0.3*vtrap((v-vshift+60-17),-5)\n"
  "	beta = 0.3*vtrap((v-vshift+60-45),5)\n"
  "	sum = alpha+beta        \n"
