...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
...
#endif
  hoc_register_prop_size(_mechtype, 39, 9);
  ...
  hoc_register_dparam_semantics(_mechtype, 8, "ks_ion");
 	...
 	ivoc_help("help ?1 ichan2 C:/Users/tlu/Documents/GitHub/rise-group-a-2020/glna/ichan2.mod\n");
 ...
 v=_v;
{
  ...
  eks = _ion_eks;
 { error =  states();
 if(error){fprintf(stderr,"at line 76 in file ichan2.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 }   }}
